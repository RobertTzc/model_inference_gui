...
import torch
import  classifier_Bird_I.MixMatch.models.wideresnet as wmodels
from PIL import Image
import numpy as np
import classifier_Bird_I.MixMatch.dataset.waterfowl as dataset
...
def mixmatch_classifier_inference(model_dir,image_list,detection_root_dir,text_out_dir,visual_out_dir,device):
