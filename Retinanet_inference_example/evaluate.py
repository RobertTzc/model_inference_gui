...
gt_root_dir = '/home/zt253/Models/Retinanet_inference_example/example_images/Bird_I_Test'
gt_folder_list = glob.glob(os.path.join(gt_root_dir,'*'))


for gt_folder_dir in gt_folder_list:
    pd_folder_dir = os.path.join(gt_folder_dir.replace('example_images','Results'),'detection-results')
    #print (pd_folder_dir)
